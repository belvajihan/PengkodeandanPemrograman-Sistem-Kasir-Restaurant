...
<head>
    ...
    <title>Login to Try Our Best Menu We Have!</title>
...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <div id="judul-form" class="text-center h1 mt-5">WELCOME TO TREASURE AND HEAVEN FOOD AT BELVA'S RESTO!!</div><br>
        ...
        <div class="mx-auto rounded p-5" style="width: 500px; background-color: white;">
            ...
            <div class="d-flex justify-content-between">
                ...
                <button id="tab-login" class="btn btn-primary fw-bold" style="width: 190px;"> LEGGOOO LOGIN</button>

                <button class="btn btn-outline-primary fw-bold" style="width: 190px;">REGISTER TO START EXPERIENCE WITH US</button>
            ...
            <form id="form" action="login.php" method="POST">
                ...
                <button class="btn btn-primary" name="login">LEGGO LOGINN</button>
