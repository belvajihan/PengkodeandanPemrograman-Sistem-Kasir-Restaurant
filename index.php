...
<body class="bg-light">
    ...
    <div class="container-fluid position-fixed top-0 bg-dark p-2 d-flex justify-content-between" style="z-index: 2;">
        ...
        <div class="text-white h3 d-flex">
            ...
            <span class="mx-3">WELCOME TO BELVA'S WORLWIDE RESTO!</span>

        </div>

        <a class="btn btn-danger fw-bold" href="logout.php" onclick="return confirm('Ingin Logout?')">ESCEPE IN HERE, don't forget back again yeah!</a>
    ...
    <div id="dropdown-menu" class="container-fluid position-fixed float-start bg-dark text-white w-auto vh-100" style="display: none; z-index: 1; top: 50px;">
        ...
        <ul>
            ...
            <li><a class="text-decoration-none p-2 h5 text-light" href="index.php">LOOK AT WE HAVE DELICIOUS MENU</a></li><br>

            <?php if (isset($_SESSION["akun-admin"])) { ?>

            <li><a class="text-decoration-none p-2 h5 text-light" href="index.php?pesanan">ORDERING MAKES HAPPY</a></li><br>

            <li><a class="text-decoration-none p-2 h5 text-light" href="index.php?transaksi">ON THE WAY TRANSACTION</a></li>
