...
<div class="d-flex flex-wrap justify-content-between">
    ...
    <nav class="navbar navbar-light">
        ...
        <form action="index.php" method="GET" class="form-inline d-flex">
            ...
            <button class="btn btn-success mx-2" name="search">Find me here</button>
    ...
    <nav class="navbar navbar-light">
        ...
        <a class="btn btn-success fw-bold mx-2" href="tambah.php">+ Add your dish here</a>
...
<form action="index.php" method="POST">
    ...
    <div class="d-flex">
        ...
        <button class="btn btn-success my-2 mx-2" name="pesan">Order ur meal!</button>
