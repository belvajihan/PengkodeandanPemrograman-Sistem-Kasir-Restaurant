<table class="table table-bordered table-hover" style="margin-top: 100px;">
    ...
    <tr class="text-bg-success">
        ...
        <th>Lovely Customer</th>

        <th>The Time</th>

        <th>Total Money Cash</th>
        ...
        <form action="cetak/cetak.php" target="_blank" method="GET">
            ...
            <tr style="background-color: green;">
                ...
                <td>
                    ...
                    <a class="btn btn-danger" href="hapus.php?kode_pesanan=<?= $m["kode_pesanan"]; ?>" onclick="return confirm('Hapus Data Transaksi?')">Remove me?</a>
